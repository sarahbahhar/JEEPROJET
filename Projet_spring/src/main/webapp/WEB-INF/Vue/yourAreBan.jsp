        ...
        <div >
            ...
            <form action="${pageContext.request.contextPath}/home.jsp" method="get">
                ...
                <table >
                    ...
                    <tr>
                        <td colspan="2">
                            <small>Une fois la date de bannissement passée, veuillez vous reconnecter pour réactiver votre compte.</small>
                        </td>
                    </tr>
                </table>
                <button type="submit" class="lien">Retour à l'accueil</button>
            </form>
        </div>
